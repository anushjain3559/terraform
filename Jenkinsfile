properties([ parameters([
  string( name: 'AWS_ACCESS_KEY_ID', defaultValue: 'AKIAZQKYEJVGJIEIWNVK'),
  string( name: 'AWS_SECRET_ACCESS_KEY', defaultValue: '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'),
